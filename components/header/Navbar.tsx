...
import LikesTotalHeaderIsland from 'deco-sites/deco-camp-fe/islands/LikesTotalHeaderIsland.tsx'
  ...
  if (device === 'mobile') {
    return (
      ...
      >
        <MenuButton />
        {logo && (
          <a href="/" class="flex-grow inline-flex items-center justify-center" style={{ minHeight: navbarHeight }} aria-label="Store logo">
