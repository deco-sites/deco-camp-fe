...
export default function Intro({
  ...
  return (
    <section class="bg-base-100">
      <div class="xl:container xl:mx-auto mx-5 md:mx-10 py-8 lg:py-10">
        <div class={`flex flex-col gap-6 ${ALIGNMENT_TEXT[alignment ?? 'Left']}`}>
          <h1 class="font-bold text-base-content text-[40px] leading-[120%]">{text}</h1>
