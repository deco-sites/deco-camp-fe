...
export default function HeroFlats({ title = 'Hero', description = 'Your description here', image, placement, cta }: Props) {
  return (
    <div>
      <div class="mx-auto flex flex-col items-center gap-8">
        ...
        >
          {image && (
            <Image
              width={640}
              class="w-full lg:w-1/2 object-fit px-6 box-border max-w-screen-sm"
          ...
          >
            ...
            ></div>
            <p class="text-zinc-400 text-[16px] md:text-[18px] leading-[150%]">{description}</p>
